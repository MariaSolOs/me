...
const ResearchPage = () => (
    <Container>
        ...
        <Text>
            ...
            in 2019. Supervised by David Kreindler, I looked into similarity measures to analyze mood symptom
            time-series data.<br />
            Our results were published in the{' '}
            <Link
                href="https://www.sciencedirect.com/science/article/pii/S0165032722004554?dgcid=coauthor"
                target="_blank"
                rel="noopener noreferrer">
        ...
        <Text>
            ...
            and explored bisimulation metrics for reinforcement learning.
        </Text>
    </Container>
);
