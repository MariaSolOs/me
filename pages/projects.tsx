    ...
    <Container>
        ...
        <Gallery>
            <ProjectCard image={rambleImg}>
                ...
                allows anyone to create and attend a wide range of unique experiences. I coded every single line of code
                in Ramble, using Typescript, Next JS, a MongoDB database and an Apollo GraphQL server.
            </ProjectCard>
            <ProjectCard image={paradeigmaImg}>
                ...
                <Link
                    ...
                    rel="noopener noreferrer">
                    Paradeigma
                </Link>, and easily find the code examples you need (and even generate snippets to use in your IDE!).
            </ProjectCard>
            <ProjectCard image={ohbaImg}>
                After a semester of being a &quot;virtual&quot; TA during the COVID-19 pandemic, I created{' '}
                <Link
                ...
                for having office hours by appointment, so students could get help without waiting for hours in Zoom
                waiting rooms.
            </ProjectCard>
            <ProjectCard image={pwaSimulatorImg}>
                ...
                to help web developers visualize this json file, and also delivered a{' '}
                <Link
        ...
        <Gallery>
            <ProjectCard image={hilbertImg}>
                ...
                <Link
                    ...
                    rel="noopener noreferrer">
                    Hilbert Space
                </Link>, a real analysis pun that went too far. Do you know the difference between &forall; and &exist;?
            </ProjectCard>
            <ProjectCard image={ratonImg}>
                ...
                are all my own. Still a WIP, but a cute, classic game nonetheless (gotta love those <i>Tom and Jerry</i>
                {' '}
                vibes).
            </ProjectCard>
        </Gallery>
        ...
        <Description>
            ...
            When I&apos;m not figuring out the dark mysteries of Visual Studio extensibility, I sometimes give my 2¢ to
            VS Code extensions.
        </Description>
        <Gallery>
            <ProjectCard image={vsLintingImg}>
                ...
                <Link
                    ...
                    target="_blank"
                    rel="noopener noreferrer">
                    I rewrote the built-in linting extension
                </Link>, enabling ESLint{' '}
            ...
            <ProjectCard image={addMultifileImg}>
                ...
                was my first VS Code extension,{' '}
